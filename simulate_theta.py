...
# ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
# plt.text(0.5, 0.1, txt, ha='center', weight='bold', transform=ax.transAxes)
# plt.savefig('Figures/Theta_motion_n4_mun{}_vs{}_psi{}_a{}_phioff{}.png'.format(
#   str(mu_n), str(int(vel_s)), str(int(incline*180/np.pi)), str(int(np.pi/alpha_0)),
#   str(int(phi_offset*180/np.pi))))
...
# ax.set_position([box.x0, box.y0, box.width*0.8, box.height])
# ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
# fig2.savefig('Figures/Theta_torques_n4_mun{}_vs{}_psi{}_a{}_phioff{}.png'.format(
#   str(mu_n), str(int(vel_s)), str(int(incline*180/np.pi)), str(int(np.pi/alpha_0)),
#   str(int(phi_offset*180/np.pi))))
...
# plt.grid()
# fig3.tight_layout()
# fig3.savefig('Figures/Theta_torqueavgs_n4_mun{}_vs{}_psi{}_a{}_phioff{}.png'.format(
#   str(mu_n), str(int(vel_s)), str(int(incline*180/np.pi)), str(int(np.pi/alpha_0)),
#   str(int(phi_offset*180/np.pi))))
...
# plt.grid()
# fig4.tight_layout
# fig4.savefig('Figures/Theta_heading_n4_mun{}_vs{}_psi{}_a{}_phioff{}.png'.format(
#   str(mu_n), str(int(vel_s)), str(int(incline*180/np.pi)), str(int(np.pi/alpha_0)),
#   str(int(phi_offset*180/np.pi))))
...
# Kn = 1
# vel_s = 0.5
# phi_offset = - 3 * np.pi/180 + np.pi/2
# heading = 0
# Bl = 2*Kn*np.pi/L
# Bn = 2*Kn*np.pi/n
# period = (L / vel_s)
...
# ax.set_position([box.x0, box.y0, box.width*0.8, box.height])
# ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
# plt.text(0.5, 0.075, txt, ha='center', weight='bold', transform=ax.transAxes)
# plt.savefig('Figures/Theta_motion_mun{}_vs{}_psi{}_a{}_phioff{}.png'.format(
#   str(mu_n), str(int(vel_s)), str(int(incline*180/np.pi)), str(int(np.pi/alpha_0)),
#   str(int(phi_offset*180/np.pi))))
